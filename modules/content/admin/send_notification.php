...
if (empty($exist))
{
	echo msg('it looks like you don\'t have any users in your mobile app or simply you have no integrated mobile app', 'danger');
}else{
	$exist = $db->getOne("SELECT 1 FROM `bbc_user_push` WHERE 1 LIMIT 1");
	if (empty($exist))
	{
