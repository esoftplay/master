		...
		<div class="form-group">
			...
			<div class="form-control-static form-control-plaintext">
				<form action="" class="form-inline" method="post" name="Download" role="form">
					...
					<input name="Submit" type="submit" value="Download" class="btn btn-default btn-secondary">
				</form>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="form-control-static form-control-plaintext">
				<form action="" method="post" name="Upload" class="form-inline" enctype="multipart/form-data">
					...
					<input name="Submit" type="submit" value="Upload" class="btn btn-default btn-secondary">
				</form>
			</div>
		</div>
<?php
		...
		<div class="form-group">
			...
			<div class="form-control-static form-control-plaintext">
				<form action="" method="post" name="import" class="form-inline">
					...
					<input name="Submit" type="submit" value="Import" class="btn btn-default btn-secondary">
				</form>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="form-control-static form-control-plaintext">
				<form action="" method="post" name="Syncronize_to" class="form-inline">
					...
					<input name="Submit" type="submit" value="Syncron" class="btn btn-default btn-secondary">
					<input name="Submit" type="submit" value="Reset" class="btn btn-default btn-secondary">
				</form>
			</div>
		</div>
	<?php
...
?>
	...
	<div class="panel-footer">
		<span type="button" class="btn btn-default btn-secondary btn-sm" onclick="document.location.href='index.php?mod=_cpanel.template';"><span class="glyphicon glyphicon-chevron-left"></span></span>
	</div>
</div>
<?php
