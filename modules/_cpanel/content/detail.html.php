...
if (!empty($data['publish']))
{
	...
	$output = array(
		...
		'images'           => $data['images'],
		'title'            => $data['title'],
		'intro'            => preg_replace('~(\ssrc=["|\']?)(blocks|images|includes|modules|templates)/~is', '$1'._URL.'$2/', $data['intro']),
		'content'          => preg_replace('~(\ssrc=["|\']?)(blocks|images|includes|modules|templates)/~is', '$1'._URL.'$2/', $data['content']),
		'description'      => preg_replace('~(\ssrc=["|\']?)(blocks|images|includes|modules|templates)/~is', '$1'._URL.'$2/', $data['description']),
