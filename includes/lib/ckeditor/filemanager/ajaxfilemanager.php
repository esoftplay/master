...
<script type="text/javascript">var _ROOT="<?php echo _URI; ?>";var _URL="<?php echo _URL; ?>";<?php echo $sys->content_read(_ROOT.'templates/script.js');?></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/jquery.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/form.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/select.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/thickbox.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/calendar.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/contextmenu.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/media.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaxfileupload.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaxfilemanager.js"></script>
<script type="text/javascript">
	var _URL = '<?php echo _URL; ?>';
	var _ROOT = '<?php echo _ROOT; ?>';
	var _URI = '<?php echo _URI; ?>';
	var CONFIG_SYS_DEFAULT_PATH = '<?php echo CONFIG_SYS_DEFAULT_PATH; ?>';
	var CONFIG_SYS_DEFAULT_URL = '<?php echo CONFIG_SYS_DEFAULT_URL; ?>';
	var globalSettings = {'upload_init':false};
	var queryString = '<?php echo makeQueryString(array('path')); ?>';
	var paths = {'root':'', 'root_title':'<?php echo LBL_FOLDER_ROOT; ?>'};
	var parentFolder = {};
	var urls = {
			...
			'present':'<?php echo _URL.'user/files/'; ?>',
	...
	var tb_pathToImage = "<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/images/loadingAnimation.gif";
	...
	$(document).ready(function(){
		...
		$('.inputMtime').calendar({autoPopUp:'both', buttonImage:'<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/images/date_picker.png'});
...
<?php
	...
	{
	?>
	<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/<?php echo 'for_' . CONFIG_EDITOR_NAME . '.js'; ?>"></script>
	<?php
	}
?>
<link rel="stylesheet" type="text/css" href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/ajaxfilemanager.css" />
<link rel="stylesheet" type="text/css" href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/<?php echo CONFIG_EDITOR_NAME; ?>.css" />
<link rel="stylesheet" type="text/css" href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/jquery-calendar.css" />
<link rel="stylesheet" href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/thickbox.css" type="text/css" media="screen" />
<!--[if IE 6]>
<link href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/ie6.css" type="text/css" rel="Stylesheet" media="screen">
<![endif]-->
</head>
<body>
	<div id="wrapper">
...
<form action="" method="POST" name="formAction" id="formAction"><input type="hidden" name="currentFolderPath" id="currentFolderPathVal" value="" /><select name="selectedDoc[]" id="selectedDoc" style="display:none;" multiple="multiple"></select><input type="hidden" name="action_value" value="" id="action_value" /></form>
							...
							<?php
								if(CONFIG_LOAD_DOC_LATTER)
								{
									...
									<select class="input inputSearch" name="search_folder" id="search_folder">
										<?php
										foreach(getFolderListing(CONFIG_SYS_DEFAULT_PATH) as $k=>$v)
										{
											$v = str_replace(CONFIG_SYS_DEFAULT_PATH, '', $v.'/');
											if (empty($v))
											{
												$v = '/';
											}else{
												$v = trim(str_replace(CONFIG_SYS_DEFAULT_PATH, '', $v), '/');
											}
											?>
	...
	_Bbc(function($){
		var onResize = function(){
			...
			if (!window.pagination_height) {
				window.pagination_height = $(".pagination_content").height();
			};
