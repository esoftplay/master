...
if (!defined("_SQLPARSER_BASEDIR"))
	define("_SQLPARSER_BASEDIR", "./");

//require_once 'PEAR.php';
include_once ( _SQLPARSER_BASEDIR .'Lexer.php' );
...
// {{{ function SQL_Parser($string = null)
    function __construct($string = null, $dialect = "MySQL") {
...
// {{{ function setDialect($dialect)
    function setDialect($dialect) {
        if (in_array($dialect, $this->dialects)) {
			...
			/////////////////////////////////////////////////
			// include2an perlu perhatian lebih
            include ( _SQLPARSER_BASEDIR . 'Dialect_'.$dialect.'.php' );
			/////////////////////////////////////////////////
...
// }}}
    ...
    function raiseError($message) {
        ...
        return $this->oggixRaiseError($message);
    }
    // }}}
...
//                    $tree['column_names'] = array_keys($fields);
	...
	// ini buatannya oggix
	function oggixRaiseError( $error = '' )
	{
		die( "oggixSqlParse Error on Line : ". __LINE__ ." : $error" );
	}
}
?>
