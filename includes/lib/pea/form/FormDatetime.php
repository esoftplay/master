...
include_once _PEA_ROOT.'form/FormDate.php';
class FormDatetime extends FormDate
{
	...
	function __construct()
	{
		...
		$this->params = array(
			...
			'format'                   => 'yyyy-mm-dd hh:ii:ss',	// String. Default: “mm/dd/yyyy” -- The date format, combination of d, dd, D, DD, m, mm, M, MM, yy, yyyy.
